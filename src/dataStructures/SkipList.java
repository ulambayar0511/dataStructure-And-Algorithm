...
public class SkipList implements Dictionary {
     ...
     *                    key than this
     * @param maxElements largest number of elements to be stored in the dictionary
    ...
    public String toString() {
        ...
        if (currentNode != tailNode) {// nonempty list
                                      // do first element
    ...
    private class SkipListIterator implements Iterator {
         ...
         * @throws NoSuchElementException when if there is no next element
         */
        public Object next() {
    ...
    public static void main(String[] args) {
        ...
        // test get
        System.out.println("element " + x.get(new Integer(1)) + " has key 1");
        System.out.println("element " + x.get(new Integer(2)) + " has key 2");
        System.out.println("element " + x.get(new Integer(6)) + " has key 6");
